...
public class Main {
    public static void main(String[] args) {
        ...
        // Membuat array manager dan staff
        manager man[] = new manager[2];
        staff staff1[] = new staff[2];
        staff staff2[] = new staff[3];

        // Mengisi data manager pertama
        man[0] = new manager();
        man[0].setNama("Tedjo");
        man[0].setNip("101");
        man[0].setGolongan("1");
        ...
        // Menampilkan informasi manager dan staff
        man[0].lihatInfo();
        man[1].lihatInfo();
    }
}
